...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/libupnp.pc.in $(top_srcdir)/build-aux/ar-lib \
	...
	$(top_srcdir)/upnp/inc/upnpconfig.h.in AUTHORS COPYING \
	ChangeLog INSTALL NEWS THANKS TODO build-aux/ar-lib \
...
ACLOCAL = ${SHELL} /usr/src/SABA-Tischfernsprecher-W48/libupnp/build-aux/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /usr/src/SABA-Tischfernsprecher-W48/libupnp/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/src/SABA-Tischfernsprecher-W48/libupnp/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/src/SABA-Tischfernsprecher-W48/libupnp/build-aux/missing --run automake-1.12
AWK = mawk
CC = gcc
...
MAKEINFO = ${SHELL} /usr/src/SABA-Tischfernsprecher-W48/libupnp/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 1.6.19
abs_builddir = /usr/src/SABA-Tischfernsprecher-W48/libupnp
abs_srcdir = /usr/src/SABA-Tischfernsprecher-W48/libupnp
abs_top_builddir = /usr/src/SABA-Tischfernsprecher-W48/libupnp
abs_top_srcdir = /usr/src/SABA-Tischfernsprecher-W48/libupnp
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /usr/src/SABA-Tischfernsprecher-W48/libupnp/build-aux/install-sh
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-pdf install-pdf-am install-pkgconfigexecDATA \
	install-ps install-ps-am install-strip installcheck \
	installcheck-am installdirs installdirs-am maintainer-clean \
	maintainer-clean-generic mostlyclean mostlyclean-generic \
	mostlyclean-libtool pdf pdf-am ps ps-am tags tags-recursive \
	uninstall uninstall-am uninstall-pkgconfigexecDATA
